...
public:
  IndexScheduler( //td::actor::ActorId<DbScanner> db_scanner,
    td::actor::ActorId<InsertManagerInterface> insert_manager,
    td::actor::ActorId<ParseManager> parse_manager, uint32_t from_seqno = 0,
    uint32_t max_active_tasks = 32, QueueState max_queue = QueueState{30000, 30000, 500000, 500000},
    int32_t stats_timeout = 10)
